...
* {: id="20210309181757-wfaicgc"}编译时，看“父类”，只能调用父类声明的方法，不能调用子类扩展的方法；
  {: id="20210309181757-lsof5dw"}
* {: id="20210309181757-v4kmwqq"}运行时，看“子类”，一定是执行子类重写的方法体；
