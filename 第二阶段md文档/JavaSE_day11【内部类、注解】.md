...
* {: id="20210310104858-oyu3ybm"}总结:
  ...
  * {: id="20210310104904-unuxlu2"}非静态内部类需要逐层创建对象外部类引用名.
    {: id="20210310104904-o62dnoc" updated="20210310104957"}
...
* {: id="20210309181757-v1eon36"}局部内部类中是否能访问外部类的静态还是非静态的成员，取决于所在的方法
